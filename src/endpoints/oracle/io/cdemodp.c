// #ifdef RCSID
// static char *RCSid = "$Header: cdemodp.c 28-feb-2005.11:23:54 eegolf Exp $ ";
// #endif /* RCSID */
...
//   */ OCIDirPathColArray *dpobjca_ctl;       /* dp column array handle for
//   obj*/ OCIDirPathColArray *dpnestedobjca_ctl; /* dp col array hndl for
//   nested obj*/ OCIDirPathStream *dpstr_ctl;           /* direct path stream
//   handle */ ub1 *buf_ctl;           /* pre-alloc'd buffer for out-of-line
//   data */ ub4 bufsz_ctl;          /* size of buf_ctl in bytes */ ub4
//   bufoff_ctl;         /* offset into buf_ctl */ ub4 *otor_ctl;          /*
//   Offset to Recnum mapping */ ub1 *inbuf_ctl;         /* buffer for input
//   records */ struct pctx pctx_ctl;   /* partial field context */ boolean
//   loadobjcol_ctl; /* load to obj col(s)? T/F */
// };
...
//                      struct obj *objp, text *recp, ub4 rowoff, ub1 bufflg
//                      _*/);
...
// STATICF void reset_obj_ca(
//     /*_ struct loadctl *ctlp, struct tbl *tblp, struct obj *objp _*/);
...
//   checkerr((dvoid *)errhp, (ub4)(htype), (sword)(status), (text *)0, (sb4)0,   \
...
//   output_fp =
//       (session.outfn_sess) ? fopen((char *)session.outfn_sess, "w") : stderr;
...
//   OCI_CHECK(ctlp->envhp_ctl, OCI_HTYPE_ENV, ociret, ctlp,
//             OCIHandleAlloc((dvoid *)ctlp->envhp_ctl, (dvoid
//             **)&ctlp->errhp_ctl,
...
//   /* begin a session */
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCISessionBegin(ctlp->svchp_ctl, ctlp->errhp_ctl,
//             ctlp->authp_ctl,
...
//                        (dvoid *)ctlp->authp_ctl, (ub4)0,
//                        (ub4)OCI_ATTR_SESSION, ctlp->errhp_ctl));
...
// **  Description:
// **
// ** Function allocates the column arrays for any objects or nested object
// *columns.
// **
// **  Assumptions:
// **
...
// STATICF void alloc_obj_ca(
//     ctlp, tblp, objp) struct loadctl *ctlp; /* load control structure pointer
//     */
...
//    */
//   OCI_CHECK(ctlp->envhp_ctl, OCI_HTYPE_ENV, ociret, ctlp,
//             OCIHandleAlloc((dvoid *)(objp->ctx_obj), (dvoid
//             **)&(objp->ca_obj),
//                            (ub4)OCI_HTYPE_DIRPATH_FN_COL_ARRAY, (size_t)0,
//                            (dvoid **)0));
...
//   /*
//    * If there are fewer rows in the object column array than in them
//    top-level,
...
// STATICF void init_obj_load(ctlp, tblp, objp) struct loadctl *ctlp;
// struct tbl *tblp;
// struct obj *objp;
// {
//   struct col *colp;
...
//    */
//   OCI_CHECK(ctlp->envhp_ctl, OCI_HTYPE_ENV, ociret, ctlp,
//             OCIHandleAlloc((dvoid *)ctlp->dpctx_ctl, (dvoid
//             **)&(objp->ctx_obj),
//                            (ub4)OCI_HTYPE_DIRPATH_FN_CTX, (size_t)0,
//                            (dvoid **)0));
...
//                          (ub4)OCI_HTYPE_DIRPATH_FN_CTX, (dvoid
//                          *)objp->name_obj, (ub4)strlen((const char
//                          *)objp->name_obj), (ub4)OCI_ATTR_NAME,
//                          ctlp->errhp_ctl));

//     /* Set the expression type to obj constructor, opaque/sql function, or
//     ref
//      * table name.
//      */
...
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrSet((dvoid *)(objp->ctx_obj),
//                          (ub4)OCI_HTYPE_DIRPATH_FN_CTX, (dvoid *)&exprtype,
//                          (ub4)0, (ub4)OCI_ATTR_DIRPATH_EXPR_TYPE,
//                          ctlp->errhp_ctl));
//   }
...
//                        (dvoid *)&numCols, (ub4)0, (ub4)OCI_ATTR_NUM_COLS,
//                        ctlp->errhp_ctl));

//   /* get the column parameter list */
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((dvoid *)(objp->ctx_obj), OCI_HTYPE_DIRPATH_FN_CTX,
//                        (dvoid *)&objColLstDesc, (ub4 *)0,
//                        OCI_ATTR_LIST_COLUMNS, ctlp->errhp_ctl));

//   /* get attributes of the column parameter list */
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((CONST dvoid *)objColLstDesc, OCI_DTYPE_PARAM,
//                        (dvoid *)&parmtyp, (ub4 *)0, OCI_ATTR_PTYPE,
//                        ctlp->errhp_ctl));
...
//        i < objp->ncol_obj; i++, pos++, colp++, fldp++) {
//     /* get parameter handle on the column */
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIParamGet((CONST dvoid *)objColLstDesc, (ub4)OCI_DTYPE_PARAM,
//                           ctlp->errhp_ctl, (dvoid **)&colDesc, pos));
...
// STATICF void
//     init_load(ctlp, tblp,
//               sessp) struct loadctl *ctlp; /* load control structure pointer
//               */
// struct tbl *tblp;                          /* table pointer   */
...
//             OCIHandleAlloc((dvoid *)ctlp->envhp_ctl, (dvoid
//             **)&ctlp->dpctx_ctl,
//                            (ub4)OCI_HTYPE_DIRPATH_CTX, (size_t)0, (dvoid
//                            **)0));
...
//                        (dvoid *)tblp->name_tbl, (ub4)0, (ub4)OCI_ATTR_NAME,
//                        ctlp->errhp_ctl));
...
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrSet((dvoid *)dpctx, (ub4)OCI_HTYPE_DIRPATH_CTX,
//                          (dvoid *)&tblp->parallel_tbl, (ub4)0,
//                          (ub4)OCI_ATTR_DIRPATH_PARALLEL, ctlp->errhp_ctl));
//   }
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrSet((dvoid *)dpctx, (ub4)OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&tblp->ncol_tbl, (ub4)0,
//                        (ub4)OCI_ATTR_NUM_COLS, ctlp->errhp_ctl));
...
//   /* get attributes of the column parameter list */
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((CONST dvoid *)ctlp->colLstDesc_ctl, OCI_DTYPE_PARAM,
//                        (dvoid *)&parmtyp, (ub4 *)0, OCI_ATTR_PTYPE,
//                        ctlp->errhp_ctl));
...
//        i < tblp->ncol_tbl; i++, pos++, colp++, fldp++) {
//     /* get parameter handle on the column */
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
...
//       OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//                 OCIAttrSet((dvoid *)colDesc, (ub4)OCI_DTYPE_PARAM,
//                            (dvoid *)&flg, (ub4)0, (ub4)OCI_ATTR_DIRPATH_OID,
//                            ctlp->errhp_ctl));
//     }
...
//     /* get column name */
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrGet((dvoid *)colDesc, OCI_DTYPE_PARAM, (dvoid *)&s,
//                          (ub4 *)&slen, OCI_ATTR_NAME, ctlp->errhp_ctl));
...
//     {
//       fprintf(output_fp, "*** ERROR *** bad column name in column
...
//     /* get column type */
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrGet((dvoid *)colDesc, OCI_DTYPE_PARAM, (dvoid *)&dty,
//                          (ub4 *)0, OCI_ATTR_DATA_TYPE, ctlp->errhp_ctl));
//     if (dty != colp->exttyp_col) {
//       fprintf(output_fp, "*** ERROR *** bad OCI_ATTR_DATA_TYPE in col
...
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrGet((dvoid *)colDesc, OCI_DTYPE_PARAM, (dvoid *)&maxdsz,
//                          (ub4 *)0, OCI_ATTR_DATA_SIZE, ctlp->errhp_ctl));
//     if (maxdsz != fldp->maxlen_fld) {
//       fprintf(output_fp, "*** ERROR *** bad OCI_ATTR_DATA_SIZE in col
//       param\n"); fprintf(output_fp, "\tColumn name %s\n", colp->name_col);
//       fprintf(output_fp, "\t\texpected %d, got %d\n", (int)fldp->maxlen_fld,
//               (int)maxdsz);
//     }
...
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIAttrSet((dvoid *)dpctx, (ub4)OCI_HTYPE_DIRPATH_CTX,
//                          (dvoid *)&tblp->xfrsz_tbl, (ub4)0,
//                          (ub4)OCI_ATTR_BUF_SIZE, ctlp->errhp_ctl));
...
//             OCIHandleAlloc((dvoid *)ctlp->dpctx_ctl, (dvoid
//             **)&ctlp->dpca_ctl,
//                            (ub4)OCI_HTYPE_DIRPATH_COLUMN_ARRAY, (size_t)0,
//                            (dvoid **)0));

//   OCI_CHECK(ctlp->envhp_ctl, OCI_HTYPE_ENV, ociret, ctlp,
//             OCIHandleAlloc((dvoid *)ctlp->dpctx_ctl, (dvoid
//             **)&ctlp->dpstr_ctl,
//                            (ub4)OCI_HTYPE_DIRPATH_STREAM, (size_t)0,
//                            (dvoid **)0));
...
// STATICF void simple_load(
//     ctlp, tblp, sessp,
//     inputfp) struct loadctl *ctlp; /* load control structure pointer */
// struct tbl *tblp;                  /* table pointer   */
// struct sess *sessp;                /* session pointer */
...
//         /* note that each call to do_convert() will convert all
//         contiguousrows
//          * in the colarray until it hit a row in error while converting.
//          */
//         cvtrv = do_convert(ctlp, startoff, rowCnt, &cvtCntPerCall,
//         &cvtBadCoff); cvtCnt += cvtCntPerCall; /* sum of rows converted so
//         far in colarray*/ if (cvtrv == CONVERT_SUCCESS) {
...
//            * 10.2 because compiler warning for pointless comparison of
//            unsigned
//            * interger */
...
//            */
//           ociResetErr = OCIDirPathStreamReset(ctlp->dpstr_ctl,
//           ctlp->errhp_ctl); if (ociResetErr != OCI_SUCCESS)
//             FATAL("OCIDirPathStreamReset failed", ociResetErr);
//         } else {
...
//         state = DO_LOAD; /* deal with data already converted, but not
//         loaded*/
//       else if (rowCnt)
...
// STATICF void
//     finish_load(ctlp) struct loadctl *ctlp; /* load control structure pointer
//     */
// {
...
//       FATAL("do_convert:OCIDirPathColArrayToStream:Unexpected OCI return
//       code",
//             ocierr);
//       /* NOTREACHED */
//       break;
...
//               OCIAttrGet((CONST dvoid *)ctlp->dpca_ctl,
//                          OCI_HTYPE_DIRPATH_COLUMN_ARRAY, (dvoid *)(cvtCntp),
//                          (ub4 *)0, OCI_ATTR_ROW_COUNT, ctlp->errhp2_ctl));

//     OCI_CHECK(ctlp->errhp2_ctl, OCI_HTYPE_ERROR, ocierr2, ctlp,
//               OCIAttrGet((CONST dvoid *)ctlp->dpca_ctl,
//                          OCI_HTYPE_DIRPATH_COLUMN_ARRAY, (dvoid *)(&badcol),
//                          (ub4 *)0, OCI_ATTR_COL_COUNT, ctlp->errhp2_ctl));
//   }
...
// #if 1
//   ocierr =
//       OCIDirPathLoadStream(ctlp->dpctx_ctl, ctlp->dpstr_ctl,
//       ctlp->errhp_ctl);
// #else
//   {
//     ub1 *bufaddr;
...
//                          OCI_HTYPE_DIRPATH_STREAM, (dvoid *)&bufaddr, (ub4
//                          *)0, OCI_ATTR_BUF_ADDR, ctlp->errhp_ctl));
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ocierr, ctlp,
//               OCIAttrGet((CONST dvoid *)(ctlp->dpstr_ctl),
//                          OCI_HTYPE_DIRPATH_STREAM, (dvoid *)&buflen, (ub4
//                          *)0, OCI_ATTR_BUF_SIZE, ctlp->errhp_ctl));
...
//     OCI_CHECK(ctlp->errhp2_ctl, OCI_HTYPE_ERROR, ocierr2, ctlp,
//               OCIAttrGet((CONST dvoid *)(ctlp->dpstr_ctl),
//                          OCI_HTYPE_DIRPATH_STREAM, (dvoid *)loadCntp, (ub4
//                          *)0, OCI_ATTR_ROW_COUNT, ctlp->errhp2_ctl));
//   }
...
// STATICF void field_flush(
//     ctlp, rowoff) struct loadctl *ctlp; /* load control structure pointer */
...
//       /*
//       **  Check the field length is not longer than the current record
//       length.
...
//         if (!prntflg) {
//           fprintf(output_fp,
//                   "Warning: Max field length, %d for record %d, is greater "
//                   "than the current record size %d.\n",
...
//         } else {
//           /* XXX: do something on read failure, like return an error
//           context*/ field_flush(ctlp, rowoff); /* close file, free filename*/
...
//     OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//               OCIDirPathColArrayEntrySet(ca, ctlp->errhp_ctl, rowoff,
//                                          colp->id_col, cval, clen, cflg));
...
// STATICF void errprint(errhp, htype, errcodep) dvoid *errhp;
// ub4 htype;
// sb4 *errcodep;
// {
//   text errbuf[512];
...
//     (void)OCIErrorGet((dvoid *)errhp, (ub4)1, (text *)NULL, errcodep, errbuf,
//                       (ub4)sizeof(errbuf), htype);
...
// STATICF void checkerr(errhp, htype, status, note, code, file,
//                       line) dvoid *errhp;
// ub4 htype;
// sword status;
// text *note;
...
// STATICF void cleanup(
//     ctlp, ex_status) struct loadctl *ctlp; /* load control structure pointer
//     */
// sb4 ex_status;
// {
//   sword ociret;
...
//   if (ctlp->dpca_ctl) {
//     ociret =
//         OCIHandleFree((dvoid *)ctlp->dpca_ctl,
//         OCI_HTYPE_DIRPATH_COLUMN_ARRAY);
...
//     OCI_HTYPE_DIRPATH_STREAM); if (ociret != OCI_SUCCESS)
//       CHECKERR(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret);
//   }
...
// **-------------------------------------------------------------------------
// */
// STATICF void free_obj_hndls(ctlp, objp) struct loadctl *ctlp;
// struct obj *objp;
// {
//   ub2 i;
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrSet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&load_mode, 0, OCI_ATTR_DIRPATH_MODE,
//                        ctlp->errhp_ctl));

//   /* Set the dirpath version to 1 */
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrSet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&version_text, 0, OCI_ATTR_VERSION,
//                        ctlp->errhp_ctl));
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrSet((dvoid *)(ctlp->dpstr_ctl), OCI_HTYPE_DIRPATH_STREAM,
//                        (dvoid *)&stream_version, 0, OCI_ATTR_VERSION,
//                        ctlp->errhp_ctl));
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrSet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid **)&attrp_nam, attr_nam_len, OCI_ATTR_NAME,
//                        ctlp->errhp_ctl));
...
//             OCIAttrSet((dvoid *)(ctlp->dpctx_ctl),
//             (ub4)OCI_HTYPE_DIRPATH_CTX,
//                        &convert_value, 0, OCI_ATTR_DIRPATH_CONVERT,
//                        ctlp->errhp_ctl));
...
//             OCIAttrSet((dvoid *)(ctlp->dpctx_ctl),
//             (ub4)OCI_HTYPE_DIRPATH_CTX,
//                        &granule_offset, 0, OCI_ATTR_DIRPATH_GRANULE_OFFSET,
//                        ctlp->errhp_ctl));
...
//   ociret = OCIAttrSet((dvoid *)(ctlp->dpctx_ctl), (ub4)OCI_HTYPE_DIRPATH_CTX,
...
//             OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&mode, (ub4 *)0, OCI_ATTR_DIRPATH_MODE,
//                        ctlp->errhp_ctl));

//   /* Verify the mode. */
//   if (mode != load_mode) {
//     fprintf(output_fp, "ERROR: expected direct path load mode of %d, got
//     %d\n",
//             load_mode, mode);
//   }
...
//             OCIAttrGet((CONST dvoid *)(ctlp->dpctx_ctl),
//             OCI_HTYPE_DIRPATH_CTX,
//                        &rows_loaded, (ub4 *)0, OCI_ATTR_NUM_ROWS,
//                        ctlp->errhp_ctl));

//   /* Then write this value back to the attribute - expect error on return*/

//   ociret = OCIAttrSet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                       &rows_loaded, (ub4)0, OCI_ATTR_NUM_ROWS,
//                       ctlp->errhp_ctl);
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&ret_charsetid, (ub4 *)0,
//                        OCI_ATTR_CHARSET_ID, ctlp->errhp_ctl));

//   /* Verify the character set id. */
//   if (charsetid != ret_charsetid) {
//     fprintf(output_fp, "ERROR: expected character set id of %d, got %d\n",
...
//             (ub4)OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&parallel_opt, (ub4 *)0,
//                        (ub4)OCI_ATTR_DIRPATH_PARALLEL, ctlp->errhp_ctl));

//   if (tblp->parallel_tbl)
//     parallel_enabled = TRUE;

//   /* Verify that the correct setting for parallel was returned. */
//   if (parallel_opt != parallel_enabled) {
//     fprintf(output_fp, "ERROR: expected parallel value of %d, got %d\n",
...
//     fprintf(output_fp, "ERROR: expected value of nolog to be %d, got %d\n",
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((dvoid *)(ctlp->dpctx_ctl), OCI_HTYPE_DIRPATH_CTX,
//                        (dvoid *)&ret_version, (ub4 *)0, OCI_ATTR_VERSION,
//                        ctlp->errhp_ctl));
...
//   if (strncmp((const char *)obj_constr_ptr, (const char *)ret_obj_constr_ptr,
//               (size_t)ret_obj_constr_len)) {
//     fprintf(output_fp, "*** ERROR *** bad object constructor name\n");
//     fprintf(output_fp, "\texpected %s, got %s\n", (char *)obj_constr_ptr,
//             (char *)ret_obj_constr_ptr);
//   }
...
//             OCIAttrGet((CONST dvoid *)(ctlp->dpctx_ctl),
//             OCI_HTYPE_DIRPATH_CTX,
//                        &scn_base, (ub4 *)0, OCI_ATTR_SCN_BASE,
//                        ctlp->errhp_ctl));

//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((CONST dvoid *)(ctlp->dpctx_ctl),
//             OCI_HTYPE_DIRPATH_CTX,
//                        &scn_wrap, (ub4 *)0, OCI_ATTR_SCN_WRAP,
//                        ctlp->errhp_ctl));
...
//             OCIAttrGet((CONST dvoid *)(ctlp->dpctx_ctl),
//             OCI_HTYPE_DIRPATH_CTX,
//                        &input_type, (ub4 *)0, OCI_ATTR_DIRPATH_INPUT,
//                        ctlp->errhp_ctl));
...
//             OCIAttrGet((CONST dvoid *)(ctlp->dpctx_ctl),
//             OCI_HTYPE_DIRPATH_CTX,
//                        &lock_wait, (ub4 *)0, OCI_ATTR_DIRPATH_LOCK_WAIT,
//                        ctlp->errhp_ctl));
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((CONST dvoid *)(ctlp->dpstr_ctl),
//                        OCI_HTYPE_DIRPATH_STREAM, &out_stream_version, (ub4
//                        *)0, OCI_ATTR_VERSION, ctlp->errhp_ctl));

//   /* Verify the stream version number. */
//   if (stream_version != out_stream_version) {
//     fprintf(output_fp,
//             "ERROR: expected (using stream handle) a stream version of %d,
//             got "
//             "%d\n",
...
//   OCI_CHECK(ctlp->errhp_ctl, OCI_HTYPE_ERROR, ociret, ctlp,
//             OCIAttrGet((CONST dvoid *)(ctlp->dpstr_ctl),
//                        OCI_HTYPE_DIRPATH_STREAM, &stream_offset, (ub4 *)0,
...
// **  Description:
// **
// ** Function resets the column arrays for any objects or nested object
// columns.
// **
// **  Assumptions:
// **
...
// STATICF void
//     reset_obj_ca(ctlp, tblp,
//                  objp) struct loadctl *ctlp; /* load control structure */
// struct tbl *tblp;                            /* table descriptor */
// struct obj *objp;                            /* object descriptor */
// {
//   struct col *colp;
