...
// const SourceEndpoint = struct {
//     reader: Reader = undefined,

//     pub fn init(allocator: std.mem.Allocator, options: ep.Options.Source) SourceEndpoint {
//         return .{ .reader = Reader.init(allocator, options) };
//     }
//     pub fn endpoint(self: *SourceEndpoint) ep.Endpoint {
//         return .{
//             .ptr = self,
//             .vtable = &.{
//                 .run = run,
...
//         };
//     }
//     fn run(ctx: *anyopaque, wire: *ep.w.Wire) anyerror!void {
//         var self: *SourceEndpoint = @ptrCast(@alignCast(ctx));
//         try self.reader.run(wire);
//     }
// };

// pub fn new(allocator: std.mem.Allocator, options: ep.Options) ep.Endpoint {
//     switch (options) {
//         .Source => |o| {
//             return SourceEndpoint.init(allocator, o).endpoint();
//         },
//         .Sink => {
//             unreachable;
//         },
