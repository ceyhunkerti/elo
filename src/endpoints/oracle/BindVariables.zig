...
pub fn init(allocator: std.mem.Allocator, stmt: *Statement, columns: []md.Column, capacity: u32) !BindVariables {
...
pub fn deinit(self: *BindVariables) !void {
...
pub fn add(self: *BindVariables, index: u32, record: *p.Record) !void {
